...
/*
 ...
 están situados los edificios en el fichero de entrada. xi, xDerechaerecha, h, siendo. Siendo
 xi la coordenada en X origen del edificio iésimo, xDerechaerecha la coordenada final en X, y h la altura del edificio.
...
int n = 5;
int i=0;
int xi,y,xDerechaerecha;
for(i=0;i<n;i++)
{
xi=(int)(Math.random()*100);
y=(int)(Math.random()*100);
xDerechaerecha=(int)(xi+(Math.random()*100));
this.addEdificio(new Edificio(xi,y,xDerechaerecha));
}
...
Punto p2 = new Punto();   // punto donde se guardara en su X la xDerechaerecha del efificio y en su Y le pondremos el valor 0
...
p2.setX(edificio.getxDerechaerecha());       
...
//        }
        ...
        try
        {
            ...
            {
                xi = sr.nextInt();
                xDerechaerecha = sr.nextInt();
                y = sr.nextInt();

                Edificio Salida = new Edificio(xi, y, xDerechaerecha);
